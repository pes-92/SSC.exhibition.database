...
이는 도형에서도 동일하게 적용된다.
![[직선에 대한 대칭이동 이미지(출처 및 저작권 통합논술 개념어 사전 한림학사. 저작권무료 아님 주의).png]]
...
이는 도형의 방정식에서도 동일하다.
![[x=y인 선에 대한 대칭이동(출처 및 저작권 통합논술 개념어 사전 한림학사. 저작권 무료 아님 주의).png]]
...
이는 도형에서도 동일하다.
![[직선에 대한 점의 대칭이동(출처 및 저작권 통합논술 개념어 사전 한림학사. 저작권 무료 아님 주의).png]]
