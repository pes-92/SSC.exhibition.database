  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a class="curriculum-link-button external" href="https://wbook.jihak.co.kr/SynapDocViewServer/viewer/doc.html?key=0501616d9344475787bf245496dd77d9&convType=img&convLocale=ko_KR&contextPath=/SynapDocViewServer" target="_blank" rel="noopener">
          1. 혼합물의 분리<br>(22개정 지학사 과학 5-2 pp 12-29)</a></td>
    ...
    <tr>
      ...
      <td></td>
      <td></td>
      <td>정수 처리시설의 단계별 기능과 과학 원리 이해하기 활동 과정에서 수량 사이의 관계와 공간적 규칙을 찾아 수학적으로 표현하고 해석함</td>
      <td></td>
    </tr>
    <tr>
      <td>
      ...
      <td></td>
      <td></td>
      <td>정수 처리시설의 단계별 기능과 과학 원리 이해하기 활동 과정에서 생명체의 구조와 기능 및 생명 현상이 유지되는 원리를 이해함</td>
      <td></td>
    </tr>
    <tr>
      <td></td>
