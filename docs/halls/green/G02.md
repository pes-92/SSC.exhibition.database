...
![전시물 이미지](../../image/exhibition/green/G02.JPG)

<div class="callout note">
  <div class="callout-title">전시 목적</div>
  <div class="callout-body">
    ‘자연과 도시가 조화를 이루는 공존의 도시 서울의 모습’ 관련 LED 프로펠러를 활용한 입체영상 홀로그램 장치 및 영상을 보고 잔상 효과와 홀로그램에 대해 알아본다.
  </div>
</div>
...
<div class="callout note">
  ...
  <div class="callout-body">
    패널에서는 자신의 핸드폰을 이용해 간단한 체험을 해볼 수 있게 안내되어있으나, 기본적으로는 회전형 LED패널을 이용한 유사홀로그램으로만 구성된 전시물
  </div>
</div>
...
<table class="curriculum-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td></td>
      <td></td>
      <td>홀로그램을 통한 영상 보기 활동 과정에서 빛의 진행과 반사·굴절, 색과 영상이 나타나는 원리를 관찰하고 이해함</td>
      <td></td>
    </tr>
    <tr>
      <td></td>
    ...
    <tr>
      ...
      <td></td>
      <td></td>
      <td>홀로그램을 통한 영상 보기 활동 과정에서 과학 지식과 탐구가 기술·사회·생활 및 진로에 미치는 영향을 이해함</td>
      <td></td>
    </tr>
  </tbody>
</table>
...
### 1.3 체험
##### 체험1) 홀로그램을 통한 영상 보기
1. 전시물 아래에 표시된 발 모양 위에 선다.
2. 돌아가는 회전날개가 만들어 내는 영상을 본다.
3. 눈에 보이는 영상과 패널의 카메라로 찍은 전시물 사진을 비교해본다.
  <br><a style="color:red"> ※ 안전사고의 우려가 있으니 물건이나 손으로 회전날개를 만지지 않는다.</a>
...
<details class="callout note">
  <summary class="callout-title">
    허공에 떠 있는 나무와 물고기의 원리는?
  </summary>

  <div class="callout-body">
    <img src="docs/image/exhibition/green/pannel/G02_main.jpg">
  </div>
</details>
...
<div data-theories="잔상디스플레이, 잔상효과, 홀로그램"></div>
...
<div class="doc-tags" data-tags="착시, 잔상효과, 홀로그램"></div>
-->
