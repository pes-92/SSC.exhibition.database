...
![전시물 이미지](../../image/exhibition/green/G34.jpg)

<div class="callout note">
  <div class="callout-title">전시 목적</div>
  <div class="callout-body">
    지구 46억 년 동안의 5대 대멸종 사건과 해당 시기의 환경, 멸종 생물에 대한 정보를 본다. 여섯 번째 대멸종의 시작점과 원인을 지구환경 지표의 변화와 인간 활동 지표의 변화를 비교한 대가속 그래프를 통해 찾아본다.
  </div>
</div>
...
<div class="callout note">
  ...
  <div class="callout-body">
    대가속 그래프들을 비교해볼 수 있는 체험요소가 있는 전시물
  </div>
</div>
...
<tr>
  ...
  <td><a class="curriculum-link-button external" href="https://ibook.vivasam.com/CBS_iBook/6656/contents/index.html?skin=basic01" target="_blank" rel="noopener">
      II-01 기후위기의 원인과 심각성<br>(22개정 비상교과서 기후변화와 환경생태 pp44-51)</a></td>
  <td>대가속 그래프가 나옴</td>
  <td></td>
</tr>
  </tbody>
...
### 1.3 체험
##### 체험1) 돌림판의 그래프 비교해보기
1. 돌림판을 돌려 그래프 두 개를 서로 겹쳐본다.
2. 그래프를 비교한 후, 나오는 문구를 확인한다
3. 벽면 패널을 보고 예상되는 여섯 번째 대멸종과 기존 5번의 대멸종의 차이를 확인한다.
...
<details class="callout note">
  ...
  <div class="callout-body">
    <img src="docs/image/exhibition/green/pannel/G34_main.jpg">
  </div>
</details>
...
<details class="callout note">
  ...
  <div class="callout-body">
    <img src="docs/image/exhibition/green/pannel/G34_sub.jpg">
  </div>
</details>
