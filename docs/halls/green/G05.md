...
![전시물 이미지](../../image/exhibition/green/G05.jpg)

<div class="callout note">
  <div class="callout-title">전시 목적</div>
  <div class="callout-body">
    도시화로 인해 자연환경이 파괴되어 동식물의 삶의 터전이 위협받게 된 배경을 알아보고, 그로 인해 점점 사라져가는 멸종 위기종을 영상으로 살펴본다.
  </div>
</div>
...
<table class="curriculum-table">
  ...
  <tbody>
    <tr>
          ...
          <td>도시화로 인한 생태계 부정적인 영향 활동 과정에서 인간 활동과 환경 변화의 관계를 살펴보고 지속가능한 해결 방법을 생각함</td>
          <td></td>
        </tr>
    <tr>
          <td>
    ...
    <tr>
          ...
          <td>생물다양성의 보존을 위한 환경보호 방식에 대해 생각함</td>
          <td></td>
        </tr>
    <tr>
          <td>
          ...
          <td></td>
          <td></td>
          <td>도시화로 인한 생태계 부정적인 영향 활동 과정에서 관찰·측정·분류와 증거를 활용하는 과학 탐구 과정을 이해함</td>
          <td></td>
        </tr>
    <tr>
          <td>
...
### 1.3 체험
##### 체험1) 도시화로 인한 생태계 부정적인 영향 살펴보기
1. 패널을 통해 도시화로 인한 자연생태계 파괴 요인을 알아본다.
2. 벽면 영상으로 멸종위기에 처한 포유류, 조류, 식물들의 현황과 위협 요인을 살펴본다.
...
<details class="callout note">
  ...
  <div class="callout-body">
    <img src="docs/image/exhibition/green/pannel/G05_main.jpg">
  </div>
</details>
...
<div data-theories="야생동물이 도시로 내려오는 이유"></div>
...
<div class="doc-tags" data-tags="환경보호, 생태계"></div>
