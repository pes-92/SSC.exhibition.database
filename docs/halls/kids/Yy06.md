...
![전시물 이미지](../../image/exhibition/yyellow/YY06_exhibit.jpg)

<div class="callout note">
  <div class="callout-title">전시 목적</div>
  <div class="callout-body">
    슬리퍼 모형을 다양한 바닥 재질에 올려보는 체험을 통해 재질에 따른 미끄러운 정도를 알아보고, 마찰력에 대해 이해한다.
  </div>
</div>
...
<div class="callout note">
  ...
  <div class="callout-body">
    슬리퍼 모형과 마찰력이 서로 다른 바닥의 미끄럼틀로 이루어진 전시물
  </div>
</div>
...
<table class="curriculum-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td></td>
      <td></td>
      <td>더 미끄러운 바닥 활동 과정에서 힘과 운동의 관계 및 에너지의 전달과 전환을 실제 현상에 적용해 이해함</td>
      <td></td>
    </tr>
    <tr>
      <td>
...
### 1.3 체험
##### 체험1) 더 미끄러운 바닥 확인하기
1. 손잡이에 연결된 가드로 막아둔 상태로 슬리퍼 모형을 한 칸에 하나씩 올린다.
2. 손잡이를 돌려 동시에 미끄러지는 슬리퍼 중 어떤 것이 먼저 떨어지는지 관찰한다.
3. 경사로와 같은 재질로 된 패널을 만져보며 어떤 곳에서 미끄러지기 쉬운지 확인한다.

### 1.4 패널내용

<details class="callout note">
  <summary class="callout-title">
    미끄러운 곳과 미끄럽지 않은 곳은 무슨 차이가 있나요?
  </summary>

  <div class="callout-body">
    <img src="docs/image/exhibition/yyellow/pannel/YY06_main.jpg">
  </div>
</details>
...
<details class="callout note">
  ...
  <div class="callout-body">
    <img src="docs/image/exhibition/yyellow/pannel/YY06_sub.jpg">
  </div>
</details>

<details class="callout note">
  <summary class="callout-title">
    우리 집에서 가장 미끄러운 곳은 어디일까요?
  </summary>

  <div class="callout-body">
    <img src="docs/image/exhibition/yyellow/pannel/YY06_texture.jpg">
  </div>
</details>
