...
<table class="curriculum-table">
  ...
  <tbody>
    <tr>
          ...
          <td>비가 내리는 이유 활동 과정에서 물질의 성질과 구조, 변화 과정에서 나타나는 현상을 관찰하고 이해함</td>
          <td></td>
        </tr>
    <tr>
          <td>
          ...
          <td>비가 내리는 이유 활동 과정에서 대기와 해양에서 나타나는 현상 및 날씨와 기후의 변화를 이해함</td>
          <td></td>
        </tr>
    <tr>
          <td>
          ...
          <td><a class="curriculum-link-button external" href="https://s3.ap-northeast-2.amazonaws.com/tsol.jihak.co.kr/tsol/22tp/m/sci/JIHAKSA_%EA%B3%BC%ED%95%991_%EC%A4%91_%EA%B5%90%EA%B3%BC%EC%84%9C.pdf" target="_blank" rel="noopener">
              IV-2-01 상태변화와 입자모형<br>(22개정 지학사 중등1 pp 130-135)</a></td>
          <td>수증기의 응결과정을 살펴봄</td>
          <td></td>
        </tr>
    <tr>
