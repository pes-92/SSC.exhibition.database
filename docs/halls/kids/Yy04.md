...
![전시물 이미지](../../image/exhibition/yyellow/YY04_exhibit.jpg)
...
<table class="curriculum-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td></td>
      <td></td>
      <td>탈수기 모형 작동 활동 과정에서 힘과 운동의 관계 및 에너지의 전달과 전환을 실제 현상에 적용해 이해함</td>
      <td></td>
    </tr>
    <tr>
      <td>
...
### 1.3 체험
##### 체험1) 탈수기 모형 작동해보기
1. 보관함의 공들을 탈수기 모형 위의 주입구에 넣는다.
2. 원판을 돌려 탈수기를 작동한다.
3. 작은 공과 큰 공이 서로 분리되는 것을 확인한다.
...
<details class="callout note">
  ...
  <div class="callout-body">
    <img src="docs/image/exhibition/yyellow/pannel/YY04_main.jpg">
  </div>
</details>
...
<details class="callout note">
  ...
  <div class="callout-body">
    <img src="docs/image/exhibition/yyellow/pannel/YY04_sub.jpg">
  </div>
</details>
