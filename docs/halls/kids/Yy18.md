...
![전시물 이미지](../../image/exhibition/yyellow/YY18_exhibit.jpg)
...
<table class="curriculum-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td></td>
      <td></td>
      <td>나만의 서울 그려보기 활동 과정에서 과학 지식과 탐구가 기술·사회·생활 및 진로에 미치는 영향을 이해함</td>
      <td></td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td></td>
      <td></td>
      <td>나만의 서울 그려보기 활동 과정에서 관찰·측정·분류와 증거를 활용하는 과학 탐구 과정을 이해함</td>
      <td></td>
    </tr>
    <tr>
      <td>
...
##### 체험1) 나만의 서울 그려보기
1. 원하는 도안을 선택해 색칠한다.
2. 스캐너에 그림을 넣고 버튼을 한 번 누른다. <br><a style="color:red"> ※ 스캔에 시간이 걸리므로 잠시 기다려야 합니다. </a>
3. 내가 그린 그림을 화면에서 찾아본다.
...
<details class="callout note">
  ...
  <div class="callout-body">
    <img src="docs/image/exhibition/yyellow/pannel/YY18_main.jpg">
  </div>
</details>
...
<details class="callout note">
  ...
  <div class="callout-body">
    <img src="docs/image/exhibition/yyellow/pannel/YY18_sub.jpg">
  </div>
</details>
