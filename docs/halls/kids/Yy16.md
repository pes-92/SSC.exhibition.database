...
# YY16 발밑 땅 속 세상이 궁금해요

## 1. 전시물 기본 내용
### 1.1 전시물 이미지

![전시물 이미지](../../image/exhibition/yyellow/YY16_exhibit.jpg)
...
<div class="callout note">
  ...
  <div class="callout-body">
    버튼을 눌러 지하의 소리를 들어볼 수 있으나 모형 및 패널 위주의 전시물
  </div>
</div>
...
<table class="curriculum-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td></td>
      <td></td>
      <td>발밑 땅 속 활동 과정에서 지권의 구성과 변화 및 지구 환경 요소의 상호작용을 이해함</td>
      <td></td>
    </tr>
    <tr>
      <td>
...
### 1.3 체험
##### 체험1) 발밑 땅 속 관찰하기
1. 평소 눈에 볼 수 없는 땅 아래 모습을 본다.
2. 유적지, 공룡 화석 등의 자연물 뿐 아니라 지하수로, 지하철과 같은 인위적인 건축물이 함께 있음을 안다.
3. 버튼을 눌러 지하철의 소리를 들어본다.
...
<details class="callout note">
  ...
  <div class="callout-body">
    <img src="docs/image/exhibition/yyellow/pannel/YY16_front.jpg">
  </div>
</details>
...
<details class="callout note">
  ...
  <div class="callout-body">
    <img src="docs/image/exhibition/yyellow/pannel/YY16_back.jpg">
  </div>
</details>
