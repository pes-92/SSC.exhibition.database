...
![전시물 이미지](../../image/exhibition/yellow/Y02.jpg)

<div class="callout note">
  <div class="callout-title">전시 목적</div>
  <div class="callout-body">
    우리가 아침에 하늘을 보고 비가 내일지 알 수 있는 이유에 대해 알아본다. 블록을 쌓아보며 비구름이 형성되는 과정에 대해 알아보고, 비구름과 일반 구름의 차이에 대해 생각해본다.
  </div>
</div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a class="curriculum-link-button external" href="https://s3.ap-northeast-2.amazonaws.com/tsol.jihak.co.kr/tsol/22tp/e/sci/JIHAKSA_%EA%B3%BC%ED%95%99_%EC%B4%88_4-1_%EA%B5%90%EA%B3%BC%EC%84%9C.pdf" target="_blank" rel="noopener">
          3. 여러 가지 기체<br>(22개정 지학사 과학 4-2 pp 64-74)</a></td>
      <td>비구름 만들어지는 법 활동 과정에서 물질의 성질과 구조, 변화 과정에서 나타나는 현상을 관찰하고 이해함</td>
      <td></td>
    </tr>
    <tr>
      <td>
      ...
      <td>비구름 만들어지는 법 활동 과정에서 대기와 해양에서 나타나는 현상 및 날씨와 기후의 변화를 이해함</td>
      <td></td>
    </tr>
<tr>
  ...
  <td>중3</td>
  <td>(교과서 링크 없음)</td>
  <td>상대습도, 단열 팽창 및 응결 현상의 관계를 이해하고, 구름의 생성과 강수 과정을 학습</td>
  <td></td>
</tr>
    <tr>
      <td>
...
### 1.3 체험
##### 체험1) 비구름 만들어지는 법 알아보기
1. 터치 모니터를 활용하여 만들어볼 비구름을 선택한다.
2. 화면에 나오는 안내에 따라 비구름을 만드는 블록을 쌓는다.
3. 비구름이 생기는 원리와 실제 구름의 모습을 살펴본다.

### 1.4 패널내용

<details class="callout note">
  <summary class="callout-title">
    아침에 하늘을 보고 비가 내릴지 알 수 있을까요?
  </summary>

  <div class="callout-body">
    <img src="docs/image/exhibition/yellow/pannel/Y02_main.jpg">
  </div>
</details>
...
<details class="callout note">
  ...
  <div class="callout-body">
    <img src="docs/image/exhibition/yellow/pannel/Y02_sub.jpg">
  </div>
</details>
