...
![전시물 이미지](../../image/exhibition/yyellow/YY13_exhibit.jpg)

<div class="callout note">
  <div class="callout-title">전시 목적</div>
  <div class="callout-body">
    무작위로 소리가 나는 창문을 눌러보는 체험을 해보고 우리의 귀가 소리나는 방향을 어떻게 파악할 수 있는지 이해한다.
  </div>
</div>
...
<div class="callout note">
  ...
  <div class="callout-body">
    소리가 나는 아파트 모형으로 구성된 전시물로 소리위치 찾기 게임을 해볼 수 있는 전시물
  </div>
</div>
...
<table class="curriculum-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>소리나는 창문 찾기 활동 과정에서 진동과 파동이 발생하고 전달되는 특성을 관찰하고 이해함</td>
      <td></td>
    </tr>
    <tr>
      <td></td>
    ...
    <tr>
      ...
      <td></td>
      <td></td>
      <td>소리나는 창문 찾기 활동 과정에서 자료를 수량화하고 가능성을 비교하거나 표와 그래프로 해석하는 방법을 이해함</td>
      <td></td>
    </tr>
    <tr>
      <td>
      ...
      <td></td>
      <td></td>
      <td>소리나는 창문 찾기 활동 과정에서 빛의 진행과 반사·굴절, 색과 영상이 나타나는 원리를 관찰하고 이해함</td>
      <td></td>
    </tr>
    <tr>
      <td>
...
##### 체험1) 소리나는 창문 찾기
1. 시작버튼을 누른다.
2. 노래(소리)가 나오는 것 같은 창문을 찾아 터치한다.
3. 올바른 창문을 터치하면 다른 창문에서 소리가 난다.
4. 제한된 시간 안에 최대한 많은 창문을 터치한다.
...
<details class="callout note">
  ...
  <div class="callout-body">
    <img src="docs/image/exhibition/yyellow/pannel/YY13_main.jpg">
  </div>
</details>
...
<details class="callout note">
  ...
  <div class="callout-body">
    <img src="docs/image/exhibition/yyellow/pannel/YY13_sub.jpg">
  </div>
</details>
