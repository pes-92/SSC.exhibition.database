...
<table class="curriculum-table">
  ...
  <tbody>
    <tr>
          ...
          <td></td>
          <td></td>
          <td>달리기 게임을 통해 나의 속력 계산 활동 과정에서 대상의 크기와 변화를 비교·측정하고 수량으로 표현하는 방법을 이해함</td>
          <td></td>
        </tr>
    <tr>
          <td>
    ...
    <tr>
          ...
          <td></td>
          <td></td>
          <td>달리기 게임을 통해 나의 속력 계산 활동 과정에서 수량 사이의 관계와 공간적 규칙을 찾아 수학적으로 표현하고 해석함</td>
          <td></td>
        </tr>
    <tr>
          <td>
          ...
          <td></td>
          <td></td>
          <td>달리기 게임을 통해 나의 속력 계산 활동 과정에서 관찰·측정·분류와 증거를 활용하는 과학 탐구 과정을 이해함</td>
          <td></td>
        </tr>
<tr>
  <td>
