...
![전시물 이미지](../../image/exhibition/orange/O15.JPG)
...
<table class="curriculum-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td></td>
      <td></td>
      <td>빛의 양에 따른 동공의 크기변화 활동 과정에서 생명체의 구조와 기능 및 생명 현상이 유지되는 원리를 이해함</td>
      <td></td>
    </tr>
    <tr>
      <td>
      ...
      <td></td>
      <td></td>
      <td>빛의 양에 따른 동공의 크기변화 활동 과정에서 물질의 성질과 구조, 변화 과정에서 나타나는 현상을 관찰하고 이해함</td>
      <td></td>
    </tr>
    <tr>
      <td></td>
    ...
    <tr>
      ...
      <td></td>
      <td></td>
      <td>빛의 양에 따른 동공의 크기변화 활동 과정에서 빛의 진행과 반사·굴절, 색과 영상이 나타나는 원리를 관찰하고 이해함</td>
      <td></td>
    </tr>
    <tr>
      <td>
...
### 1.3 체험
##### 체험1) 빛의 양에 따른 동공의 크기변화 관찰하기
1. 눈을 패널의 오른쪽 그림과 같이 접안부에 가까이 대고 스위치를 누른다.
2. 눈동자에 조명이 잘 비치도록 눈의 위치를 조절한다.
3. 회전 스위치를 돌려 조명의 밝기를 조절한다.
4. 거울(또는 모니터)에 비친 동공의 크기를 관찰한다. <br>밝기를 조절하면 동공의 크기가 어떻게 변하는지 살펴본다.
...
<details class="callout note">
  ...
  <div class="callout-body">
    <img src="docs/image/exhibition/orange/pannel/O15_main.jpg">
  </div>
</details>
...
<div data-theories="눈의 구조와 기능, 다양한 동공 모양, 동공반사, 자율신경계, 홍채의 구조와 색, 홍채의 기능"></div>
