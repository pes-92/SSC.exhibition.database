...
![전시물 이미지](../../image/exhibition/orange/O30.jpg)
...
### 1.3 체험
##### 체험1) 촉각과 청각으로 스펙트럼 알아보기
1. 손으로 원소 1~20번 방출선 스펙트럼을 만져보며 서로 비교해본다.
2. 각 우너소의 버튼을 눌러 스펙트럼이 소리로 변환된 것을 들어본다.
...
<details class="callout note">
  ...
  <div class="callout-body">
    <img src="docs/image/exhibition/orange/pannel/O30_main.jpg">
  </div>
</details>
