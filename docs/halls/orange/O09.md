...
<table class="curriculum-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td></td>
      <td></td>
      <td>합성 영상으로 생애주기별 변화 활동 과정에서 생명체의 구조와 기능 및 생명 현상이 유지되는 원리를 이해함</td>
      <td></td>
    </tr>
    <tr>
      <td>
      ...
      <td></td>
      <td></td>
      <td>합성 영상으로 생애주기별 변화 활동 과정에서 자료와 변화를 수량화하고 표나 그래프로 해석하는 방법을 이해함</td>
      <td></td>
    </tr>
    <tr>
      <td></td>
    ...
    <tr>
      ...
      <td></td>
      <td></td>
      <td>합성 영상으로 생애주기별 변화 활동 과정에서 자료를 수량화하고 가능성을 비교하거나 표와 그래프로 해석하는 방법을 이해함</td>
      <td></td>
    </tr>
    <tr>
      <td></td>
    ...
    <tr>
      ...
      <td></td>
      <td></td>
      <td>합성 영상으로 생애주기별 변화 활동 과정에서 물질의 성질과 구조, 변화 과정에서 나타나는 현상을 관찰하고 이해함</td>
      <td></td>
    </tr>
  </tbody>
</table>
...
### 1.3 체험
##### 체험1) 합성 영상으로 생애주기별 변화 알아보기
1. 조작패드의 왼쪽, 오른쪽 버튼으로 자신의 성별을 고른다.(남성 XY, 여성 XX)
2. 화면의 빨간 동그라미에 얼굴을 맞추어 조작패드의 확인 버튼으로 사진을 찍는다.
3. 사진이 잘 찍혔다면 다시 한 번 확인 버튼을 누른다.
4. 상단에 나오는 4가지 생애주기 중 하나를 좌우 버튼으로 고르고 확인 버튼을 누른다.
5. 합성된 영상을 통해 생애 주기동안 내 몸에서 벌어진(혹은 벌어질)일을 알아본다.
