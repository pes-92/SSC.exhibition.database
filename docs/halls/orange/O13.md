...
![전시물 이미지](../../image/exhibition/orange/O13.JPG)
...
### 1.3 체험
##### 체험1) 중독이 인체에 미치는 영향 알아보기
1. 패널을 보며 중독의 정의에 대해 생각해본다.
2. 술, 담배, 마약 등의 약물을 섭취했을 때 뇌에서 일어나는 반응을 알아본다.
3. 일반 사람의 뇌와 술, 담배, 인터넷, 마약에 중독된 사람의 뇌를 비교해본다.

##### 체험2) 카페인, 알코올, 담배가 인체에 미치는 영향 알아보기
1. 화면의 시작 버튼을 누르고 게임 설명을 읽어본다.
2. 확인 버튼을 눌러 게임이 시작되면 카페인, 알코올, 담배 각각 30초씩 총 3단계의 게임이 진행된다.
3. 캐릭터의 좌, 우를 눌러서 이동시켜 하늘에서 떨어지는 카페인, 알코올, 담배 분자 모형을 피한다.
4. 떨어지는 분자 모형에 닿으면 좌측 상단 건강게이지가 줄어든다.
5. 건강게이지가 완전히 바닥나면 게임 종료. 30초 동안 건강게이지가 유지되면 성공.
6. 매 단계 끝날 때마다 카페인, 알코올, 담배가 인체에 미치는 부작용과 영향을 확인한다.
...
<details class="callout note">
  <summary class="callout-title">
    우리에게 금지된 것들, 왜 안된다고 하는걸까?
  </summary>

  <div class="callout-body">
    <img src="docs/image/exhibition/orange/pannel/O13_main.jpg">
  </div>
</details>
...
<div data-theories="청소년 유해물질"></div>
