...
# O10 유전자가 반반 섞이면 어떻게 될까? (1) 너반나반

## 1. 전시물 기본 내용
### 1.1 전시물 이미지

![전시물 이미지](../../image/exhibition/orange/O10.JPG)
  ...
  <tbody>
    ...
    <tr>
      <td>
        ...
        초등학교 5~6학년 &gt; 자료와 가능성 &gt; 가능성
        </a>
      </td>
      <td></td>
      <td></td>
      <td>다양한 거울로 닮은 점 찾아보기 활동 과정에서 자료를 수량화하고 가능성을 비교하거나 표와 그래프로 해석하는 방법을 이해함</td>
      <td></td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td></td>
      <td></td>
      <td>다양한 거울로 닮은 점 찾아보기 활동 과정에서 물질의 성질과 구조, 변화 과정에서 나타나는 현상을 관찰하고 이해함</td>
      <td></td>
    </tr>
    <tr>
      <td>
...
### 1.3 체험
##### 체험1) 다양한 거울로 닮은 점 찾아보기
1. 한쪽 벽에 원하는 사람의 사진을 붙여준다.
2. 거울을 사이에 두고 사진과 눈높이를 맞춘다.
3. 격자거울을 통해 사진과 내 모습을 동시에 보면 어떻게 보이는지 확인한다.

##### 체험2) 유성생식에 대해 알아보기
1. 패널을 보며 유성생식에 대해 알아본다.
2. 부모의 생식세포가 어떻게 분열 후 결합하는지 확인한다.
3. 다른 동물들은 어떤 방법으로 생식을 하는지 알아본다.
...
<details class="callout note">
  ...
  <div class="callout-body">
    <img src="docs/image/exhibition/orange/pannel/O10_main.png">
  </div>
</details>
...
<div data-theories="감수분열, 사람의 염색체(핵형분석), 유성생식과 무성생식"></div>
