...
<table class="curriculum-table">
  ...
  <tbody>
    <tr>
          ...
          <td></td>
          <td></td>
          <td>내 심장이 두근거리는 이유는? 전시 과정에서 자료와 변화를 수량화하고 표나 그래프로 해석하는 방법을 이해함</td>
          <td></td>
        </tr>
    <tr>
          <td>
          ...
          <td>내 심장이 두근거리는 이유는? 전시 과정에서 생명체의 구조와 기능 및 생명 현상이 유지되는 원리를 이해함</td>
          <td></td>
        </tr>
    <tr>
          <td>
          ...
          <td><a class="curriculum-link-button external" href="https://ibook.vivasam.com/CBS_iBook/10777/contents/index.html?skin=basic01" target="_blank" rel="noopener">
              VI-1-04 물질을 운반하는 순환계<br>(22개정 비상교과서 중등2 pp 200-203)</a></td>
          <td>순환계에 대한 학습 및 그 핵심 기관인 심장의 구조에 대해 학습.</td>
          <td></td>
        </tr>
  </tbody>
</table>
...
<details class="callout note">
  ...
  <div class="callout-body">
    <img src="docs/image/exhibition/orange/pannel/O06_main.jpg">
  </div>
</details>
