...
# O23 탄소로 이루어진 세상은? (2) 탄소인터렉티브

## 1. 전시물 기본 내용
### 1.1 전시물 이미지

![전시물 이미지](../../image/exhibition/orange/O23.JPG)
...
### 1.3 체험
##### 체험1) 탄소로 이루어진 세상 정보영상 체험하기
1. 반짝이는 탄소화합물을 터치해본다.
2. 나타나는 탄소의 구조식과 설명을 살펴본다.
...
<details class="callout note">
  ...
  <div class="callout-body">
    <img src="docs/image/exhibition/orange/pannel/O23_main.jpg">
  </div>
</details>
